package com.github.yjz.widget.checkbox;
...
/**
 * 描述: 基于https://github.com/andyxialm/SmoothCheckBox/tree/master扩展 支持矩形、圆形
 */
public class SmoothCheckBox extends View implements Checkable {
    ...
    private void drawCenter(Canvas canvas) {
        ...
        if (shapeType == 2){
            RectF rect = new RectF(
                    mCenterPoint.x - radius*mScaleVal,
                    mCenterPoint.y - radius*mScaleVal,
                    mCenterPoint.x + radius*mScaleVal,
                    mCenterPoint.y + radius*mScaleVal
            );
    ...
    private void drawBorder(Canvas canvas) {
        ...
        if (shapeType == 2){
            RectF rect = new RectF(
                    mCenterPoint.x - radius*mFloorScale,
                    mCenterPoint.y - radius*mFloorScale,
                    mCenterPoint.x + radius*mFloorScale,
                    mCenterPoint.y + radius*mFloorScale
            );
