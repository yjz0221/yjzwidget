...
public class StateImageView extends AppCompatImageView {
    ...
    public StateImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mNormalDrawable = a.getDrawable(R.styleable.StateImageView_yjz_normalBackground);
        mPressedDrawable = a.getDrawable(R.styleable.StateImageView_yjz_pressedBackground);
        mUnableDrawable = a.getDrawable(R.styleable.StateImageView_yjz_unableBackground);
        setStateBackground(mNormalDrawable, mPressedDrawable, mUnableDrawable);

        mDuration = a.getInteger(R.styleable.StateImageView_yjz_ivAnimationDuration, mDuration);
