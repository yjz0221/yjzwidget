package com.github.yjz.widget.button.state_button;
 ...
 * @author deadline
 * @time 2016-11-07
 * github地址：https://github.com/niniloveyou/StateButton/tree/master
 */
...
public class StateButton extends AppCompatButton {
    ...
    private void setup(AttributeSet attrs) {
        ...
        mNormalTextColor = a.getColor(R.styleable.StateButton_yjz_normalTextColor, mDefaultNormalTextColor);
        mPressedTextColor = a.getColor(R.styleable.StateButton_yjz_pressedTextColor, mDefaultPressedTextColor);
        mUnableTextColor = a.getColor(R.styleable.StateButton_yjz_unableTextColor, mDefaultUnableTextColor);
        setTextColor();

        //set animation duration
        mDuration = a.getInteger(R.styleable.StateButton_yjz_animationDuration, mDuration);
        mStateBackground.setEnterFadeDuration(mDuration);
        mStateBackground.setExitFadeDuration(mDuration);

        //set background color
        mNormalBackgroundColor = a.getColor(R.styleable.StateButton_yjz_normalBackgroundColor, 0);
        mPressedBackgroundColor = a.getColor(R.styleable.StateButton_yjz_pressedBackgroundColor, 0);
        mUnableBackgroundColor = a.getColor(R.styleable.StateButton_yjz_unableBackgroundColor, 0);
        ...
        //set radius
        mRadius = a.getDimensionPixelSize(R.styleable.StateButton_yjz_radius, 0);
        mRound = a.getBoolean(R.styleable.StateButton_yjz_round, false);
        ...
        //set stroke
        mStrokeDashWidth = a.getDimensionPixelSize(R.styleable.StateButton_yjz_strokeDashWidth, 0);
        mStrokeDashGap = a.getDimensionPixelSize(R.styleable.StateButton_yjz_strokeDashWidth, 0);
        mNormalStrokeWidth = a.getDimensionPixelSize(R.styleable.StateButton_yjz_normalStrokeWidth, 0);
        mPressedStrokeWidth = a.getDimensionPixelSize(R.styleable.StateButton_yjz_pressedStrokeWidth, 0);
        mUnableStrokeWidth = a.getDimensionPixelSize(R.styleable.StateButton_yjz_unableStrokeWidth, 0);
        mNormalStrokeColor = a.getColor(R.styleable.StateButton_yjz_normalStrokeColor, 0);
        mPressedStrokeColor = a.getColor(R.styleable.StateButton_yjz_pressedStrokeColor, 0);
        mUnableStrokeColor = a.getColor(R.styleable.StateButton_yjz_unableStrokeColor, 0);
        setStroke();
